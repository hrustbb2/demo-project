...
<html>
	...
	<aside id="fh5co-aside" role="sidebar" class="text-center" style="background-image: url({{ $page->getPageOptions()->getHeaderPictureSrc() }});">
		<h1 id="fh5co-logo"><a href="index.html">{{ $page->getPageOptions()->getHeaderLabel() }}</a></h1>
	</aside>
						...
						<div class="row">
							<div class="col-lg-7">
								<div class="fh5co-intro animate-box">
									<h2>{{ $page->getPageOptions()->getPageHeader() }}</h2>
									<p>{{ $page->getPageOptions()->getPageSmallText() }}</p>
								</div>
							</div>
